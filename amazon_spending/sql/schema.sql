...
CREATE TABLE IF NOT EXISTS retailer_transactions (
    ...
    actual_skipped_at TEXT,
    actual_skip_reason TEXT,
    created_at TEXT NOT NULL DEFAULT (datetime('now')),
    updated_at TEXT NOT NULL DEFAULT (datetime('now')),
    FOREIGN KEY(order_id) REFERENCES orders(order_id),
...
CREATE INDEX IF NOT EXISTS idx_orders_retailer_order_date ON orders(retailer, order_date DESC);
CREATE INDEX IF NOT EXISTS idx_orders_order_date ON orders(order_date DESC);
CREATE INDEX IF NOT EXISTS idx_orders_total ON orders(order_total_cents);
CREATE INDEX IF NOT EXISTS idx_shipments_order_id ON shipments(order_id);
CREATE INDEX IF NOT EXISTS idx_shipments_total ON shipments(shipment_total_cents);
...
CREATE INDEX IF NOT EXISTS idx_retailer_transactions_txn_date ON retailer_transactions(txn_date);
CREATE INDEX IF NOT EXISTS idx_retailer_transactions_actual_sync ON retailer_transactions(actual_synced_at, txn_date);
